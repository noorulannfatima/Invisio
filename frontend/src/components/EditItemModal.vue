...
onMounted(() => {
  ...
  formData.Purchase_Price = props.item.Purchase_Price;
  formData.Selling_Price = props.item.Selling_Price;
});
...
const handleSubmit = async () => {
  ...
  try {
    await itemStore.updateItem(props.item.Item_ID, {
      Name: formData.Name,
      Unit: formData.Unit,
    ...
    submitError.value = err instanceof Error ? err.message : 'Failed to update item';
  } finally {
