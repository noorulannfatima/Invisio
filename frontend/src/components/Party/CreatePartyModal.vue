  ...
  <div class="modal-overlay" @click.self="closeModal">
    <div class="modal-content">
      ...
      <form @submit.prevent="handleSubmit" class="modal-form">
        ...
        <div class="form-group">
          <label for="party-balance">Outstanding Balance</label>
...
const handleSubmit = async () => {
  ...
  try {
    await partyStore.createParty({
      ...
      Type: formData.Type as 'Customer' | 'Supplier' | 'Both',
    ...
    submitError.value = err instanceof Error ? err.message : 'Failed to create party. Please try again.';
...
// Include all the styles from CreatePartyModal.vue
.modal-overlay {
  position: fixed;
  top: 0;
  left: 0;
